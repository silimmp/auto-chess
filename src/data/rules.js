...
const PREP_SECONDS_STEP = 10;
const PREP_SECONDS_CAP = 60;
const TIMER_TICK_MS = 250;
const POST_BATTLE_DELAY_MS = 1400;
const BATTLE_INTRO_DELAY_MS = 650;
const BATTLE_ACTION_DELAY_MS = 900;
const BATTLE_HIT_DELAY_MS = 620;
const BATTLE_CLEANUP_DELAY_MS = 480;
